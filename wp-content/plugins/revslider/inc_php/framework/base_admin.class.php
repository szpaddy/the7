 ...
 class UniteBaseAdminClassRev extends UniteBaseClassRev{
		...
		public static function addCommonScripts(){
			...
			if(GlobalsRevSlider::$isNewVersion){	//load new jquery ui library
				$urlJqueryUI = $prefix."ajax.useso.com/ajax/libs/jqueryui/1.10.1/jquery-ui.min.js";
				self::addScriptAbsoluteUrl($urlJqueryUI,"jquery-ui");
				
				//self::addStyle("jquery-ui-1.10.3.custom.min","jui-smoothness","css/jui/new");
				wp_enqueue_style('jui-smoothness', esc_url_raw($prefix.'ajax.useso.com/ajax/libs/jqueryui/1.10.1/themes/base/jquery-ui.css'), array(), null);
				...
				$urlJqueryUI = $prefix."ajax.useso.com/ajax/libs/jqueryui/1.8.18/jquery-ui.min.js";
				self::addScriptAbsoluteUrl($urlJqueryUI,"jquery-ui");
				//self::addStyle("jquery-ui-1.8.18.custom","jui-smoothness","css/jui/old");
				wp_enqueue_style('jui-smoothness', esc_url_raw($prefix.'ajax.useso.com/ajax/libs/jqueryui/1.8.18/themes/base/jquery-ui.css'), array(), null);
