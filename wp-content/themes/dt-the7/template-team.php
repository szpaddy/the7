		...
		<?php if ( presscore_is_content_visible() ): ?>
			...
			<div id="content" class="content" role="main">
				...
				<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); // main loop ?>
					...
					$container_classes = array( 'wf-container', 'description-on-hover' );
					$container_classes[] = ( 'masonry' == $layout ) ? 'iso-container' : 'grid-masonry';
				...
				<div class="full-width-wrap">
					...
					<div class="<?php echo $container_classes; ?>"<?php echo $masonry_container_data_attr; ?>>
