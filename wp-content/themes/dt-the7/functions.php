...
if ( ! function_exists( 'presscore_get_social_icons_data' ) ) :
	...
	function presscore_get_social_icons_data() {
		return array(
			...
			'tqq'		=> __('腾讯微博', LANGUAGE_ZONE),
			'renren'		=> __('人人网', LANGUAGE_ZONE),
			'douban'		=> __('豆瓣', LANGUAGE_ZONE),
			'baidu'		=> __('百度空间', LANGUAGE_ZONE),
			'taobao'		=> __('淘宝网', LANGUAGE_ZONE),
			'weixin'		=> __('微信', LANGUAGE_ZONE),
			'miliao'		=> __('米聊', LANGUAGE_ZONE),
			'pengyou'		=> __('朋友网', LANGUAGE_ZONE),
...
if ( ! function_exists( 'presscore_themeoptions_get_social_buttons_list' ) ) :
	...
	function presscore_themeoptions_get_social_buttons_list() {
		return array(
			'tsina'		=> __('新浪微博', LANGUAGE_ZONE),
			'tqq'		=> __('腾讯微博', LANGUAGE_ZONE),
			'renren'		=> __('人人网', LANGUAGE_ZONE),
			'qzone'		=> __('QQ空间', LANGUAGE_ZONE),
			'kaixin001'		=> __('开心网', LANGUAGE_ZONE),
			'weixin'		=> __('微信', LANGUAGE_ZONE),
			'douban'		=> __('豆瓣', LANGUAGE_ZONE),
			'taobao'		=> __('淘江湖', LANGUAGE_ZONE),
			'facebook' 	=> __('Facebook', LANGUAGE_ZONE),
			'twitter' 	=> __('Twitter', LANGUAGE_ZONE),
			'google+' 	=> __('Google+', LANGUAGE_ZONE),
			'pinterest' => __('Pinterest', LANGUAGE_ZONE),
