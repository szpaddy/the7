...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"value" => array(
				"图像下面" => "default",
				"图像悬停：左对齐" => "text_on_image",
				"图像悬停：中" => 'on_hover_centered',
				"深色渐变" => 'on_dark_gradient',
				"底部移走" => 'from_bottom'
			),
			"description" => ""
		),
