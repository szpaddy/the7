...
$options[] = array( "name" => _x("Blog", "theme-options", LANGUAGE_ZONE), "type" => "heading" );
	...
	$options[] = array(	"type" => "block_end");
	$options[] = array(	"name" => _x('中文博客字数设置', 'theme-options', LANGUAGE_ZONE), "type" => "block_begin" );
    // input
			$options[] = array(
				"name"		=> _x( '中文博客自动摘要长度', 'theme-options', LANGUAGE_ZONE ),
				"id"		=> 'general-rel_posts_djexcerpt',
				"std"		=> '200',
				"type"		=> 'text',
				// number
				"sanitize"	=> 'ppp'
